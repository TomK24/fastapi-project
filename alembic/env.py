...
from app.models import Base #Need this import from models.py not database.py because we want alembic to access the models defined in models.py
...
target_metadata = Base.metadata #Need this
